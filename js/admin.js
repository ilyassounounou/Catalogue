...
/* ---------------------------------------------------------
   GitHub API wrapper
   FIX: on force "Content-Type: application/json" par défaut,
   sinon les requêtes PUT (écriture) partent en text/plain et
   GitHub peut les rejeter ou mal les interpréter.
   --------------------------------------------------------- */
